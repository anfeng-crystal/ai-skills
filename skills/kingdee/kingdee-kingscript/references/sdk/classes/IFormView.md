...
| `showConfirm(...)` | 确认框 | 异步确认，结果回到 `MessageBoxClosedEvent` |
...
- `showConfirm` 的结果不属于页面关闭回调；确认框结果先看 `MessageBoxClosedEvent`
...
- [MessageBoxClosedEvent.md](MessageBoxClosedEvent.md)
- 3.1调试KingScript.md
